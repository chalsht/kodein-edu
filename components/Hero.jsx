        ...
        <div className="grid min-h-[calc(100vh-80px)] items-center gap-6 lg:grid-cols-2 lg:gap-0">
          ...
          >
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <motion.a
                ...
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.97 }}
                className="flex items-center justify-center gap-3 rounded-lg bg-blue-600 px-6 py-3.5 text-sm font-bold text-white shadow-lg hover:bg-blue-700"
              >
              ...
              <motion.a
                ...
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.97 }}
                className="flex items-center justify-center gap-3 rounded-lg bg-red-500 px-6 py-3.5 text-sm font-bold text-white shadow-lg hover:bg-red-600"
              >
          ...
          >
            ...
            >
              <Image
                src="/images/hero.png"
                alt="Teknologi Kodein Edu Center"
                width={700}
                height={700}
                priority
